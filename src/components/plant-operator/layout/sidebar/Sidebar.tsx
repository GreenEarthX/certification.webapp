  ...
  return (
    ...
    >
      ...
      <List sx={{ paddingTop: '16px' }}>
        {[
          { text: 'Dashboard', icon: <FaHome />, path: '/plant-operator/dashboard' }, // Add leading slash
          { text: 'Manage Plants', icon: <FaSitemap />, path: '/plant-operator/manage-plants-json' }, // Add leading slash
          { text: 'Certifications', icon: <FaFileAlt />, path: '/plant-operator/certifications' }, // Add leading slash
          { text: 'Recommendations', icon: <FaFileMedical />, path: '/plant-operator/recommendations' }, // Add leading slash
        ].map((item) => (
          <ListItem 
            key={item.text}
            component={Link} 
