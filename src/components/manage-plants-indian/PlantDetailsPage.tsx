...
import HydrogenFields from '@/components/manage-plants-indian/general-info/HydrogenFields';
import AmmoniaFields from '@/components/manage-plants-indian/general-info/AmmoniaFields';
import ENGFields from '@/components/manage-plants-indian/general-info/ENGFields';
import SAFFields from '@/components/manage-plants-indian/general-info/SAFFields';
import BiofuelFields from '@/components/manage-plants-indian/general-info/BiofuelFields';
import MethanolFields from '@/components/manage-plants-indian/general-info/MethanolFields';
...
import OffTakersStep from '@/components/manage-plants-indian/off-takers/OffTakersStep';
...
import GeneralInformations from '@/components/manage-plants-indian/general-info/GeneralInformations';
    ...
    <form className="w-full p-8 min-h-screen" autoComplete="off">
      ...
      <FacilityDropdown
        ...
        onChange={(e) => {
          ...
          router.push(`/dashboards/manage-plants-indian?selected=${newId}`);
        }}
      />
